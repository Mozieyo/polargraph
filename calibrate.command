...
python3 -m polargraph calib --grid --square 200 --cell 10 --out calibration.svg || { echo "failed"; read -n1 -s; exit 1; }
echo
...
echo "[4/4] Solving..."
echo
python3 -m polargraph calib-solve --commanded 200 200 --measured "$W" "$H"
echo
echo "------------------------------------------------------------"
